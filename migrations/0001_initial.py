# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-11-15 19:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choices', models.ManyToManyField(related_name='choiceGroups', to='db.Choice')),
            ],
        ),
        migrations.CreateModel(
            name='kwargs',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choiceGroup', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.ChoiceGroup')),
            ],
        ),
        migrations.CreateModel(
            name='Relation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valid_values', models.ManyToManyField(related_name='sourceColumns', to='db.sourceChoice')),
            ],
        ),
        migrations.CreateModel(
            name='SourceQuestion',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.SurveyQuestion'),
        ),
        migrations.AddField(
            model_name='sourcequestion',
            name='source_columns',
