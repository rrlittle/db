...
INSERT INTO `db_answer` VALUES (1,'2016-11-15',1,NULL,NULL,NULL,NULL,1,1,1,1),(2,'2016-12-02',1,NULL,NULL,NULL,NULL,1,3,3,1),(3,'2016-12-02',1,NULL,NULL,NULL,NULL,1,4,4,1),(4,'2016-12-02',-1,NULL,NULL,NULL,NULL,2,2,2,1);
...
INSERT INTO `db_choicegroup` VALUES (1,'good/not','radio','int');
...
--
-- Table structure for table `db_external_id`
--

DROP TABLE IF EXISTS `db_external_id`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `db_external_id` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `study_id` varchar(60) NOT NULL,
  `person_object_id` int(11) NOT NULL,
  `study_name_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `db_external_id_person_object_id_4fd52582_fk_db_person_id` (`person_object_id`),
  KEY `db_external_id_2f90f0f5` (`study_name_id`),
  CONSTRAINT `db_external_id_person_object_id_4fd52582_fk_db_person_id` FOREIGN KEY (`person_object_id`) REFERENCES `db_person` (`id`),
  CONSTRAINT `db_external_id_study_name_id_0183a434_fk_db_external_study_id` FOREIGN KEY (`study_name_id`) REFERENCES `db_external_study` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `db_external_id`
--

LOCK TABLES `db_external_id` WRITE;
/*!40000 ALTER TABLE `db_external_id` DISABLE KEYS */;
INSERT INTO `db_external_id` VALUES (1,'a',2,1),(2,'b',3,1),(3,'c',1,1),(4,'d',4,1);
/*!40000 ALTER TABLE `db_external_id` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `db_external_study`
--

DROP TABLE IF EXISTS `db_external_study`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `db_external_study` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `db_external_study`
--

LOCK TABLES `db_external_study` WRITE;
/*!40000 ALTER TABLE `db_external_study` DISABLE KEYS */;
INSERT INTO `db_external_study` VALUES (1,'testimport');
/*!40000 ALTER TABLE `db_external_study` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `db_sourcecolumn` VALUES (1,'q1','999',0);
...
CREATE TABLE `db_sourcescheme` (
  ...
  `name` varchar(20) NOT NULL,
  `date_of_response_col_header` varchar(60),
  `respondent_col_header` varchar(60) NOT NULL,
  `subject_col_header` varchar(60) NOT NULL,
  `study_id` int(11),
  PRIMARY KEY (`id`),
  KEY `db_sourcescheme_00b3bd7e` (`survey_id`),
  KEY `db_sourcescheme_fc091212` (`study_id`),
  CONSTRAINT `db_sourcescheme_study_id_3cf3e928_fk_db_external_study_id` FOREIGN KEY (`study_id`) REFERENCES `db_external_study` (`id`),
...
INSERT INTO `db_sourcescheme` VALUES (1,1,'testimport.csv',NULL,'person','person',NULL);
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(4,'auth','group'),(2,'auth','permission'),(3,'auth','user'),(5,'contenttypes','contenttype'),(11,'db','answer'),(7,'db','choice'),(18,'db','choicegroup'),(24,'db','external_id'),(23,'db','external_study'),(20,'db','kwargs'),(14,'db','measure'),(12,'db','person'),(9,'db','question'),(15,'db','relation'),(16,'db','sourcechoice'),(21,'db','sourcecolumn'),(22,'db','sourcequestion'),(19,'db','sourcescheme'),(8,'db','survey'),(17,'db','surveyquestion'),(6,'sessions','session');
...
-- Dump completed on 2016-12-02  9:56:49
